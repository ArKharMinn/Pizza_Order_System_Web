                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3 offset-6">
                                <form class="mb-3 form-header" action="{{ route('category#list') }}" method="GET">
                                    @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-1 offset-11">
                                <h3 class="bg-white shadow-lg text-center p-2 rounded"><i class="fa-solid fa-database"></i> {{ $categories->total() }} </h3>
                            </div>
                        </div>
