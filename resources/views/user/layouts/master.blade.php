                                  ...
                                  <li class="mt-3">
                                    <span class="dropdown-item">
                                        <form action="{{ route('logout') }}" method="POST">
                                            @csrf
                                            <button type="submit" class="btn btn-danger rounded"><i class="fa-solid fa-right-from-bracket me-2"></i>Logout</button>
                                        </form>
                                    </span>
                                  </li>
                                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <form action="{{ route('user#contact') }}" method="post">
                            ...
                            <div class="my-2">
                                <textarea cols="4" name="message" rows="4" class="form-control" placeholder="Your Message"></textarea>
                            </div>
